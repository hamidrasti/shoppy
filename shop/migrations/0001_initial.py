# Generated by Django 4.0.2 on 2022-04-21 05:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('preparing', 'Preparing'), ('prepared', 'Prepared'), ('sent', 'Sent'), ('canceled', 'Canceled'), ('referred', 'Referred'), ('delivered', 'Delivered')], default='preparing', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('none', 'None'), ('red', 'Red'), ('green', 'Green'), ('blue', 'Blue')], default='none', max_length=255)),
                ('size', models.CharField(choices=[('none', 'None'), ('small', 'Small'), ('medium', 'Medium'), ('large', 'Large')], default='none', max_length=255)),
